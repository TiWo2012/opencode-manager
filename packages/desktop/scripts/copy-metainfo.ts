...
const productName = channel === "prod" ? "OpenCode Manager" : `OpenCode Manager ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
const summary = `OpenCode Manager: open source AI coding agent${channel !== "prod" ? ` (${channel})` : ""}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      OpenCode Manager is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
  ...
  <url type="homepage">https://opencode-manager.ai</url>
