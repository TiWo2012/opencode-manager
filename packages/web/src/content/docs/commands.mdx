...
You can add custom commands through the OpenCode Manager config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your OpenCode Manager [config](/docs/config):
