...
With OpenCode Manager you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, OpenCode Manager uses our own `opencode` theme.
...
OpenCode Manager comes with several built-in themes.
...
- Want OpenCode Manager to match their terminal's appearance
...
OpenCode Manager supports a flexible JSON-based theme system that allows users to create and customize themes easily.
...
{
  "$schema": "https://opencode-manager.ai/theme.json",
  "defs": {
    "nord0": "#2E3440",
    "nord1": "#3B4252",
    "nord2": "#434C5E",
