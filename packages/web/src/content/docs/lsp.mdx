---
title: LSP Servers
description: OpenCode Manager integrates with your LSP servers.
---

OpenCode Manager can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

OpenCode Manager comes with several built-in LSP servers for popular languages:
