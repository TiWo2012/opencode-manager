---
title: Share
description: Share your OpenCode Manager conversations.
---

OpenCode Manager's share feature allows you to create public links to your OpenCode Manager conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, OpenCode Manager:
...
OpenCode Manager supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, OpenCode Manager uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `opencode-manager.json` in your project and check into Git.
