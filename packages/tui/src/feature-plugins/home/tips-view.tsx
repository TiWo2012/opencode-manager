...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public opencode-manager.ai link",
  ...
  "Use {highlight}opencode-manager run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode-manager --continue{/highlight} to resume the last session",
  "Use {highlight}opencode-manager run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opencode-manager serve{/highlight} for headless API access to OpenCode Manager",
  "Use {highlight}opencode-manager run --attach{/highlight} to connect to a running server",
  "Run {highlight}opencode-manager upgrade{/highlight} to update to the latest version",
  "Run {highlight}opencode-manager auth list{/highlight} to see all configured providers",
  "Run {highlight}opencode-manager agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode-manager{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}opencode-manager github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/opencode-manager fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}opencode-manager debug config{/highlight} to troubleshoot configuration",
