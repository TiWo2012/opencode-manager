export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenCode Manager",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenCode Manager.",
  ...
  "provider.connect.opencodeZen.visit.link": "opencode-manager.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenCode Manager.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenCode Manager.",
  ...
  "dialog.server.description": "Switch which OpenCode Manager server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "OpenCode Manager",
  ...
  "wsl.onboarding.checkingOpencode": "Checking OpenCode Manager...",
  "wsl.onboarding.checkingOpencodeIn": "Checking OpenCode Manager in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating OpenCode Manager...",
  "wsl.onboarding.updatingOpencodeIn": "Updating OpenCode Manager in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update OpenCode Manager in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update OpenCode Manager",
  "wsl.onboarding.opencodeReadyIn": "OpenCode Manager is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenCode Manager is ready.",
  "wsl.onboarding.installOpencodeIn": "Install OpenCode Manager in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install OpenCode Manager",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenCode Manager not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before OpenCode Manager can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "OpenCode Manager could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen OpenCode Manager.",
  ...
  "toast.update.description": "A new version of OpenCode Manager ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenCode Manager team",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" failed. Note, OpenCode Manager does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenCode Manager includes free models so you can start immediately.",
  ...
  "app.name.desktop": "OpenCode Manager Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OpenCode Manager server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenCode Manager",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OpenCode Manager looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description":
    "Choose whether OpenCode Manager follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenCode Manager is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenCode Manager launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenCode Manager.",
  ...
  "swarm.title": "Swarm",
  "swarm.new": "New swarm",
  "swarm.launch.local": "Local",
  "swarm.launch.worktree": "New worktree",
  "swarm.launch.swarm": "Swarm",
  "swarm.launch.local.description": "Run in the current directory",
  "swarm.launch.worktree.description": "Create a git worktree and run there",
  "swarm.launch.swarm.description": "Orchestrate multiple agents in parallel",
  "swarm.create.title": "Describe the task",
  "swarm.create.placeholder": "What should the swarm accomplish?",
  "swarm.mode.normal": "Normal",
  "swarm.mode.normal.description": "Human approval before execution",
  "swarm.mode.yolo": "YOLO",
  "swarm.mode.yolo.description": "Autonomous execution on a sandbox branch",
  "swarm.plan.summary": "Plan",
  "swarm.plan.risk": "Risk",
  "swarm.plan.approve": "Approve plan",
  "swarm.plan.start": "Start",
  "swarm.cancel": "Cancel",
  "swarm.agent.action.cancel": "Cancel agent",
  "swarm.agent.action.merge": "Merge",
  "swarm.agent.action.review": "Review",
  "swarm.agent.action.retry": "Retry",
  "swarm.agent.action.approve-merge": "Approve merge",
  "swarm.agent.feedback": "Send feedback",
  "swarm.agent.feedback.placeholder": "Describe what the agent should fix",
  "swarm.empty": "No swarm running.",
  "swarm.empty.hint": "Describe a task to start one. Append --yolo to skip human review.",
  "swarm.diagram.legend": "Dependency flow",
  "swarm.approval.required": "Approval required",
  "swarm.notify.approval": "Swarm requires approval",
  "swarm.status.idle": "idle",
  "swarm.status.planning": "planning",
  "swarm.status.running": "running",
  "swarm.status.paused": "paused",
